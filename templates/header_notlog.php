...
<nav class="navbar navbar-expand-md navbar-light bg-light sticky-top h-5">
		...
		<div class="collapse navbar-collapse" id="navbarResponsive"> 
			...
			<ul class="navbar-nav ml-auto">
				...
				<li class="nav-item active">
					<a href="form_auth.php" target="_blank" class="nav-link">Авторизация</a>
				</li>							
				<li class="nav-item">
					<a href="aboutus.php" class="nav-link">О нас</a>
				</li>
				<li class="nav-item">
