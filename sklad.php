...
?>	 
  ...
  <div class="form-group">
    ...
    <input type="text" name="mainCell[2]" class="form-control" id="formGroupExampleInput3" value="ИП Алферова А.Д." disabled>
  </div>
  <div class="form-group">
    <label for="formGroupExampleInput4">Склад</label>
    <input type="text" name="mainCell[3]" class="form-control" id="formGroupExampleInput4" value="Основной склад" disabled required>
  </div>
  <div class="form-group">
    <label for="formGroupExampleInput5">Номер накладной</label>
    <input type="text" name="mainCell[4]" class="form-control" id="numbNakl" value="" required>
  ...
  <div class="form-group">
    ...
    <input type="text" name="mainCell[5]" class="form-control" id="formGroupExampleInput4" value="<?php echo $login; ?>" readonly>
  </div>
  
  <div class="form-group">
    <label for="formGroupExampleInput7">Дата прихода</label>
    <input type="text" name="mainCell[6]" class="form-control" id="formGroupExampleInput4" value="<?php  
	$time = time()+25200;								
...
?>  " readonly>
    ...
    <input type="number" name="mainCell[7]" id="ourUp" class="form-control" min="20" max="50" value="25" required>
  </div>
  <hr>  
...
<tr>
	<td style="width:10%"> 
		<input type="text" class="form-control" name="kolvoTovars" id="kolvoTovars"  disabled> 
	</td>
    <td style="width:22%;" > <input type="text" class="form-control" id="formGroupExampleInput5" value="Общее кол-во" style="background-color:yellow;"></td>
    <td style="width:11%;"> 
		<input type="text" class="form-control" name="mainCell[8]" id="sum_kolvo" name="kol_prix" disabled>
	</td>      
	<td style="width:11%"> 
		<input type="text" class="form-control" value="Итого" style="background-color:yellow;"> 
	</td>      
	<td style="width:11%"> 
		<input type="text" class="form-control" name="mainCell[9]" id="sum_zakup" disabled> 
	</td>
	<td style="width:11%"> 
		<input type="text" class="form-control" name="mainCell[10]" id="sum_our" disabled> 
	</td>
	<td style="width:11%"> 
		<input type="text" class="form-control" name="mainCell[11]" id="sum_itogZak" disabled> 
	</td>      
	<td style="width:11%"> 
...
for (var i =1; i<= rows; i++)
	{	
		...
		document.getElementById('kolvoTovars').value=rows-1; 	// количество строк с товарами
...
function getStr() {   
	...
	countRow=countRow+1;
    row.innerHTML = 
	  "<td> <input type='text' onkeyup='sumKolvo();' name='cells["+inc+parseInt(1)+"]' class='form-control' id='numbStr' value="+inc+" style='width:40%'> </td>"+
      "<td> <input type='text' name='cell["+inc+parseInt(2)+"]' class='form-control' id='category'> </td>"+
      "<td> <input type='text' name='cell["+inc+parseInt(3)+"]' class='form-control' id='nameTov'> </td>"+
	  "<td> <input type='text' onkeyup='sumKolvo();' name='cell["+inc+parseInt(4)+"]' class='form-control' id='kolvo' value='0'> </td>"+
	  "<td> <input type='text' name='cell["+inc+parseInt(5)+"]' class='form-control' id='edIzm'> </td>"+
	  "<td> <input type='text' onkeyup='sumKolvo();' name='cell["+inc+parseInt(6)+"]' class='form-control' id='zakPrice' value='0'> </td>"+
	  "<td> <input type='text' onkeyup='sumKolvo();' name='cell["+inc+parseInt(7)+"]' class='form-control' id='ourPrice' value='0' readonly> </td>"+
	  "<td> <input type='text' onkeyup='sumKolvo();' name='cells["+inc+parseInt(8)+"]' class='form-control' id='sumItogZak' value='0' disabled> </td>"+
	  "<td> <input type='text' onkeyup='sumKolvo();' name='cells["+inc+parseInt(9)+"]' class='form-control' id='sumItogOur' value='0' disabled> </td>";
